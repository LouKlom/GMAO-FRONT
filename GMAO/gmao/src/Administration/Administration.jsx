    ...
    <div className="min-h-screen bg-gray-200">
      ...
      <div className="bg-gray-100 p-4 mx-10 mt-10 rounded-lg">
        <div className="flex justify-between">
          <button
            className="bg-green-500 text-white px-4 py-2 rounded-md md:w-1/2 hover:bg-green-600 transition duration-300"
          ...
          <button
            className="bg-yellow-600 text-white px-4 py-2 rounded-md md:w-1/2 hover:bg-yellow-700 transition duration-300"
      ...
      <div className="bg-gray-100 p-4 mx-10 mt-10 rounded-lg">
        ...
        <p>
          ...
          - Début désérialisation du token dans page de Profil
        </p> <br />
        ...
        <p>
          ...
          - Ajout administration des emplacements
        </p> <br />
        ...
        <p>
          ...
          - Mise en place bouton de déconnexion
        </p> <br />
