...
const PopupForm = ({ onClose, selectedItemId, selectedNom }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.put(`http://localhost:8080/api/fabricant/${selectedItemId}`, {
        nom: nom, 
      }, {
        headers: {
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md mt-4">
      <h2 className="text-gray-800 text-lg font-bold mb-4">Modifier un Fabricant</h2>
